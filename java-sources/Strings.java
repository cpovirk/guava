...
public final class Strings {
   ...
   */
  @PreferKotlinApi(replacement = "string.orEmpty()") // PUBLIC:strip_line
   ...
   */
  @PreferKotlinApi(replacement = "string?.ifEmpty { null }") // PUBLIC:strip_line
   ...
   */
  @PreferKotlinApi(replacement = "string.isNullOrEmpty()") // PUBLIC:strip_line
   ...
   */
  @PreferKotlinApi(replacement = "string.padStart(minLength, padChar)") // PUBLIC:strip_line
   ...
   * @return the padded string
   */
  @PreferKotlinApi(replacement = "string.padEnd(minLength, padChar)") // PUBLIC:strip_line
   ...
   */
  @PreferKotlinApi(replacement = "string.repeat(count)") // PUBLIC:strip_line
   ...
   * @since 11.0
   */
  @PreferKotlinApi(replacement = "a.commonPrefixWith(b)") // PUBLIC:strip_line
   ...
   * @since 11.0
   */
  @PreferKotlinApi(replacement = "a.commonSuffixWith(b)") // PUBLIC:strip_line
  ...
  @SuppressWarnings("CatchingUnchecked") // go/sneaky-checked-exceptions
  private static String lenientToString(@Nullable Object o) {
    ...
    try {
      return o.toString();
    } catch (Exception e) { // go/sneaky-checked-exceptions

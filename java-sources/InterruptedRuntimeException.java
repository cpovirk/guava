...
public class InterruptedRuntimeException extends RuntimeException {
   ...
   */
  public InterruptedRuntimeException(@Nullable String message) {
    super(message);
    Thread.currentThread().interrupt();
  }
   ...
   */
  public InterruptedRuntimeException(@Nullable InterruptedException cause) {
    super(cause);
    Thread.currentThread().interrupt();
  }
   ...
   */
  public InterruptedRuntimeException(
      @Nullable String message, @Nullable InterruptedException cause) {
    super(message, cause);
    Thread.currentThread().interrupt();
  }
}

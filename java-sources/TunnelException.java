 ...
 * will get <a href="http://go/TunnelExceptionMustBeCaught">additional compile time checks</a> to
 * statically enforce the correct usage of TunnelException.
 *
...
public final class TunnelException extends RuntimeException {
  ...
  @ParametricNullness
  public static <T extends @Nullable Object> T tunnel(Callable<T> callback) {
  ...
  public synchronized Exception getCause() {
    // requireNonNull is safe because we always pass a non-null cause to the superclass.

 ...
 * @author Charles Fry
 */
// TODO(kevinb): should we release this?
...
public final class Randoms {
  ...
  // TODO(martinrb): insecureRandom should return instances with a cycle of at least 2**64.
  ...
  private static class ReadOnlyRandom extends Random {
    @Serial private static final long serialVersionUID = 898001275432099254L;
  ...
  private static final class ThreadLocalSecureRandom extends Random {
    ...
    SecureRandom current() {
      // TODO(cpovirk): Remove requireNonNull, which our checker requires but shouldn't.
      return requireNonNull(localRandom.get());
    }

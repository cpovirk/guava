...
public class GoogleRuntimeException extends RuntimeException {
  ...
  private @Nullable String externalMessage = "A system error has occurred";
   ...
   */
  public GoogleRuntimeException(@Nullable String externalMessage, Throwable t) {
   ...
   * server!"
   */
  public final @Nullable String getInternalMessage() {
   ...
   */
  public final @Nullable String getExternalMessage() {

...
class Stopwatch {
 ...
 fun isRunning(): Boolean { null!! }



 
 fun start(): Stopwatch { null!! }
 ...
 companion object {
  ...
  fun createUnstarted(): Stopwatch { null!! }
  ...
  fun createStarted(): Stopwatch { null!! }
